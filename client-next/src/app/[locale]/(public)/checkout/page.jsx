    ...
    try {
      ...
      if (error.response?.data?.unavailableArtworks) {
        ...
        const confirmed = await confirm({
          ...
          description: `The following artworks are no longer available: ${titles}. Would you like to remove them from your cart and continue?`,
        ...
        if (confirmed) {
          ...
          toast.info('Items removed', {
            description: 'Unavailable items have been removed. Please review your cart and try again.',
          });
        }
      } else {
        toast.error('Order failed', {
          description: error.response?.data?.message || t('errors.orderFailed'),
        });
      }
