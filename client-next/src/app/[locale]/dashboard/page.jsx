...
// --- DATOS MOCK (Iguales a tu versión original) ---
const mockStats = {
...
export default function DashboardPage() {
    ...
    // En Next.js, el acceso a sessionStorage debe estar dentro de useEffect
    useEffect(() => {
    ...
    const handleLogout = async () => {
        try {
            ...
            // Redirección completa para limpiar estados
    ...
    if (!currentUser) return null; // Evita parpadeo de contenido mientras carga el usuario
